...
\newcommand{\fitblank}[2][\relax]{%
  ...
  \else
    % 答えが指定されている場合
    \ifshowanswer
      \underline{\hspace{1.5em}{\color{blue}#1}\hspace{1.5em}}%
    \else
      \underline{\hspace*{#2em}}%
    \fi
  \fi
...
\newcommand{\fitblankbf}[2][\relax]{%
  ...
  \else
    % 答えが指定されている場合
    \ifshowanswer
      \underline{\hspace{1.5em}{\color{blue}\textbf{#1}}\hspace{1.5em}}%
    \else
      \underline{\hspace*{#2em}}%
    \fi
  \fi
...
\newcommand{\fitblankbold}[2][\relax]{%
  ...
  \else
    % 答えが指定されている場合
    \ifshowanswer
      \underline{\hspace{1.5em}{\color{blue}\ensuremath{\bm{#1}}}\hspace{1.5em}}%
    \else
      \underline{\hspace*{#2em}}%
    \fi
  \fi
